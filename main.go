...
import (
	...
	"github.com/adminturneddevops/cluster-api-provider-rackn/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "f41ddf12.cluster.x-k8s.io",
	})
	if err != nil {
	...
	if err = (&controllers.RackNk8smachineReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "RackNk8smachine")
		os.Exit(1)
	}
