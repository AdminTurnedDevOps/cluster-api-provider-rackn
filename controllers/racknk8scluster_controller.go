...
func (r *RackNk8sclusterReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
...
func (r *RackNk8sclusterReconciler) SetupWithManager(mgr ctrl.Manager) error {
